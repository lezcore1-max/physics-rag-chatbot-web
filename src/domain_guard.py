...
PHYSICS_KEYWORDS = {
    ...
    "power", "watt", "joule", "scattering", "elastic", "inelastic", "uncertainty",
     "application", "applications", "example", "examples", "use", "uses",
    "value", "values", "formula", "equation", "derive", "derivation",
    "explain", "definition", "meaning", "principle", "concept", "law",
    "calculate", "solve", "find", "determine", "effect", "effects",
    "difference", "comparison", "compare", "relation", "relationship",
    "depend", "depends", "dependency", "cause", "causes", "reason",
    "proof", "prove", "derive", "significance", "importance", "role",
    "type", "types", "kind", "kinds", "form", "forms", "property",
    "properties", "characteristic", "characteristics", "behavior",
    "phenomenon", "phenomena", "mechanism", "process", "processes",
    "unit", "units", "dimension", "dimensions", "constant", "constants",
    "diagram", "graph", "plot", "curve", "experiment", "experimental",
    "observation", "result", "results", "conclusion", "conclusion",
    "its", "their", "this", "that", "these", "those", "such",
    "more", "further", "detail", "details", "explain", "elaborate",
    "numerically", "numerical", "mathematically", "mathematical",
    "physical", "physically", "theoretically", "theoretical",
    "practically", "practical", "real", "real-world", "everyday",
}
